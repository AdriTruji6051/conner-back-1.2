...
ROUTE_SET_PRODUCT_QUANTITY = f'{TICKETS_BASE}/set-quantity'
...
# Config - Price Tag
PRICE_TAG_BASE = f'{CONFIG_BASE}/price-tag'

ROUTE_GET_PRICE_TAG_SETTINGS = f'{PRICE_TAG_BASE}/settings'
ROUTE_UPDATE_PRICE_TAG_SETTINGS = f'{PRICE_TAG_BASE}/settings'
ROUTE_PRINT_PRICE_TAG = f'{PRICE_TAG_BASE}/print'
